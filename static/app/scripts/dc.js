...
(function (global, factory) {
  ...
  class DataCount extends BaseMixin {
       ...
       * - all: HTML templates to use if all items are selected
       * - some: HTML templates to use if not all items are selected
       * @example
       * counter.html({
  ...
  class NumberDisplay extends BaseMixin {
       ...
       * - one: HTML templates to use if the number is 1
       * - zero: HTML templates to use if the number is 0
       * - some: HTML templates to use otherwise
       * @example
       * numberWidget.html({
       *      one:'%number record',
       *      some:'%number records',
